...
mail("martin.ruscade@yahoo.com", "Message from MartinRuscade.com",
...
<head>
    ...
    <title>Martin Ruscade | Vancouver based Web Developer</title>
    <!-- font icons -->
...
<body data-spy="scroll" data-target=".navbar" data-offset="40" id="home">
    ...
    <nav class="custom-navbar" data-spy="affix" data-offset-top="20">
        <div class="container">
            <a class="logo" href="#">
                <img src="assets/martinruscade%20logo.png" height="60" width="" alt="Martin Ruscade's logo"></a>         
            <ul class="nav">
                <li class="item">
    ...
    <header id="home" class="header">
        ...
        <div class="header-content container">
            <h1 class="header-title">
                ...
                <span class="down">I am Martin Ruscade</span>
            </h1>
            <p class="header-subtitle">WEB DEVELOPER</p>            
            <a href="#portfolio">
                <button class="btn btn-primary rounded">Visit My Works</button>
            </a>
        </div>              
                ...
                <div class="col-md-6 col-lg-3">
                    <div class="service-card">
                        <div class="body">
                            ...
                            <p class="subtitle">I create modern, sharp, responsive and custom websites.</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-6 col-lg-3">
                    <div class="service-card">
                        <div class="body">
                            ...
                            <p class="subtitle">I make sure your website performs to the best possible speed .</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-6 col-lg-3">
                    <div class="service-card">
                        <div class="body">
                            ...
                            <p class="subtitle">I will help you take your brand online and make your first sale.</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-6 col-lg-3">
                    <div class="service-card">
                        <div class="body">
                            ...
                            <h6 class="title">Ad management</h6>
                            <p class="subtitle">Do you need an ad campaign for your business? I got you coverred.</p>
                        </div>
                    </div>
                </div>
            </div><!-- end of row -->
            ...
            <div class="row">
                <div class="col-md-4">
                    <a href="#" class="portfolio-card">
                        <img src="assets/imgs/gardenfx.webp" class="portfolio-card-img" alt="garden effects preview" height="490">    
                        <span class="portfolio-card-overlay">
                            <span class="portfolio-card-caption">
                                <h4>Gardenfx.ca</h4>
                                <p class="font-weight-normal">Web Design and Digital Marketing</p>
                            </span>                         
                        </span>                     
                    </a>
                </div>
                <div class="col-md-4">
                    <a href="#" class="portfolio-card">
                        <img class="portfolio-card-img" src="assets/imgs/jfpr-3.webp" class="img-responsive rounded" alt="just four paws rescue preview" height="490">
                        <span class="portfolio-card-overlay">
                            <span class="portfolio-card-caption">
                                <h4>Justfourpawsrescue.com</h4>
                                <p class="font-weight-normal">Web Design</p>
                            </span>                         
                        </span>                         
                    </a>
                </div>
                <div class="col-md-4">
                    <a href="#" class="portfolio-card">
                        <img class="portfolio-card-img" src="assets/imgs/JC3-Design-Studio-2.webp" class="img-responsive rounded" alt="jc3 design studio preview" height="490">    
                        <span class="portfolio-card-overlay">
                            <span class="portfolio-card-caption">
                                <h4>JC3designstudio.ca</h4>
                                <p class="font-weight-normal">Web Design</p>
                            </span>                         
                        </span>                     
                    </a>
    ...
    <section class="section" id="pricing">
        <div class="container text-center">
            <p class="section-subtitle">Web design options</p>
            <h6 class="section-title mb-6">My Plans</h6>
            <!-- row -->
            <div class="pricing-wrapper">
                <div class="pricing-card">
                    <div class="pricing-card-header">
                        <img class="pricing-card-icon" src="assets/imgs/scooter.svg" alt="scooter logo">
                    </div>
                    <div class="pricing-card-body">
                        <h6 class="pricing-card-title">Starter</h6>
                    ...
                    -->
                    <a href="#contact" class="btn btn-outline-primary mt-3 pricing-card-btn">Free quote</a>
                </div>
                <div class="pricing-card">
                    <div class="pricing-card-header">
                        <img class="pricing-card-icon" src="assets/imgs/shipped.svg" alt="truck logo">
                    </div>
                    <div class="pricing-card-body">
                        <h6 class="pricing-card-title">Pro</h6>
                        <div class="pricing-card-list">
                            <p>Custom brand integration</p>
                            <p>Custom design elements</p>
                            <p>Blog and / or portfolio section</p>
                            <p>Google Analytics Installation</p>
                ...
                <div class="pricing-card">
                    <div class="pricing-card-header">
                        <img class="pricing-card-icon" src="assets/imgs/startup.svg" alt="rocket logo">
                    </div>
                    <div class="pricing-card-body">
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="testimonial-card">
                        ...
                        <div class="testimonial-card-body">
                            <p class="testimonial-card-subtitle">Amazing work! I am so over the moon happy with our website! Extremely professional when dealing with us and very responsive with any changes and updates. I can't say enough positive things about Martin and the work he did and continues to do for us!</p>
                            <a href="https://justfourpawsrescue.com/" target="_blank">
                                <h6 class="testimonial-card-title">JustFourPaws.com</h6>
                            </a>
                        </div>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="testimonial-card">
                        ...
                        -->
                        <div class="testimonial-card-body">
                            <p class="testimonial-card-subtitle">Martin was very professional and effective in helping me with my website. It was easy to get things done and he made sure things were done right..</p>
                            <h6 class="testimonial-card-title">Peter Winnett</h6>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section class="section" id="contact">
        <div class="container text-center">
            ...
            <!-- contact form -->
            <form method="post" action="contactme.php" class="contact-form col-md-10 col-lg-8 m-auto">
                <div class="form-row">
    ...
    <div class="container">
        <footer class="footer">       
            <p class="mb-0">Copyright <script>document.write(new Date().getFullYear())</script> &copy; <a href="http://martinruscade.com">MartinRuscade</a></p>
            <div class="social-links text-right m-auto ml-sm-auto">
                <a href="https//www.martinruscade.com" class="link"><i class="ti-layout-tab"></i></a>
                <a href="https://twitter.com/MartinRUSCADE" class="link"><i class="ti-twitter-alt"></i></a>
                <a href="https://www.instagram.com/accounts/login/?next=%2Fmartin_ruscade%2F&source=omni_redirect" class="link"><i class="ti-instagram"></i></a>
                <a href="https://github.com/Rusmartin" class="link"><i class="ti-github"></i></a>
            </div>
        </footer>
